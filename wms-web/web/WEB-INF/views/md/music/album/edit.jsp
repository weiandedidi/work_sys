        ...
        <div class="tab-content">
            <div class="tab-pane fade  active in" id="tab_1_1">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-4">专辑名<span class="required">*</span></label>
                            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-4">唱片公司<span class="required">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="recordCompany" value="${album.recordCompany}"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select name="busTypeId" id="busTypeId"  class="form-control">
                                    <option value="">请选择...</option>
                                    <c:forEach var="item" items="${busTypeList}">
                                        <option value="${item.id}" <c:if test="${album.busTypeId==item.id}">selected</c:if>>${item.itemName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-4">歌曲数量<span class="required">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="musicNum" value="${album.musicNum}"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-2">发布日期<span class="required">*</span></label>
                            <div class="col-md-9">
                                <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" id="pubTime" name="pubTime" value="${album.pubTime}"/>
                            </div>
                        </div>
                    </div>
                </div>
