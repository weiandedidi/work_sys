define(function (require, exports, module) {
    ...
    var PageEdit = require("./mult_page_edit");
    var ShowEdit = require("./mult_show_edit");
    var Item = require("./mult_item");
    ...
    Page.prototype.initEvents = function () {
        ...
        $(this.el_table).off("click.op_item").on("click.op_item", 'a[data-sign="op_item"]', function () {
            var $op_row = $(this).closest('span[data-sign="op_row"]');
            that.opItem({id: $op_row.data("id"), name: $op_row.data("name")});
        });
        // 上线
    ...
    Page.prototype.initTable = function () {
        ...
        this.dataTable = $(this.el_table).dataTable({
            ...
            "ajax": {
                "url": App.ctx + "/pub/conf/mult/pg/list",
                "type": "POST",
                "data": function (d) {
    ...
    Page.prototype.opItem = function (data) {
        var that = this;
    ...
    Page.prototype.opOnline = function (row) {
        ...
        $.ajax({
            url: App.ctx + "/pub/conf/mult/online",
            type: "post",
            data: {id: row.id},
