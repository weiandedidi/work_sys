define(function (require, exports, module) {
    ...
    ShowEdit.prototype.loadContent = function () {
        var that = this;
        var url = App.ctx + "/pub/conf/mult/page/show/edit" + " " + this.el_form;
    ...
    ShowEdit.prototype.btnSave = function () {
        ...
        // 保存请求
        $.ajax({
            url: App.ctx + "/pub/conf/mult/show/save",
            type: "post",
