define(function (require, exports, module) {
    ...
    Page.prototype.initTable = function () {
        ...
        this.dataTable = $('#table_list').dataTable({
            "columnDefs": [
                ...
                {"targets": 2, "title": "唱片公司", "data": "recordCompany"},
                {"targets": 3, "title": "发布日期", "data": "pubTime"},
                {"targets": 4, "title": "歌曲数量", "data": "musicNum"},
                {
                    "targets": 5, "title": "有效状态",
    ...
    Page.prototype.editStatus = function (data) {
        var that = this;
        $.post(App.ctx + "/md/music/album/editStatus",{id:data.id},function(result){
            if (result.rsCode == 1) {
