define(function (require, exports, module) {
    ...
    Page.prototype.initEvents = function () {
        ...
        $(this.el_query_form+" #albumId").change(function () {
            that.refreshTable();
        });
        $(this.el_query_form+" #resType").change(function () {
            that.refreshTable();
        });
    ...
    Page.prototype.initTable = function () {
        ...
        this.dataTable = $('#table_list').dataTable({
            "columnDefs": [
                ...
                {"targets": 1, "title": "视频标题", "data": "title"},
    ...
    Page.prototype.editStatus = function (data) {
        var that = this;
        $.post(App.ctx + "/md/video/editStatus",{id:data.id},function(result){
            if (result.rsCode == 1) {
