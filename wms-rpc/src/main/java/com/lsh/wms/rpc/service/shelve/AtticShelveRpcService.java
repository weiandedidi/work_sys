...
import com.lsh.wms.api.service.shelve.IAtticShelveRpcService;
...
public class AtticShelveRpcService implements IAtticShelveRpcService {
    private static Logger logger = LoggerFactory.getLogger(AtticShelveRpcService.class);
